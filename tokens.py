...
def categorize_tokens(code):
    ...
    for token in tokens:
        ...
        # Treat certain tokens as separators
        elif token_type in (tokenize.NEWLINE, tokenize.INDENT, tokenize.DEDENT, tokenize.LPAR, tokenize.RPAR, tokenize.COMMA, tokenize.COLON, tokenize.DOT, tokenize.SEMI):
            separators.append(token_string)
        # Skip certain tokens
        elif token_type in (tokenize.ENDMARKER, tokenize.ERRORTOKEN):
            continue
